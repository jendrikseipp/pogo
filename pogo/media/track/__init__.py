...
class Track:
    ...
    def getBitrate(self):
        ...
        if bitrate == -1:
            return _('unknown')
        elif self.getEncMode() == 1:
            return '~ %u kbps' % (bitrate // 1000)
        else:
            return '%u kbps' % (bitrate // 1000)
    ...
    def getURI(self):
        ...
        try:
            return self.tags[TAG_SCH] + '://' + self.tags[TAG_RES]
        except:
            raise RuntimeError('The track is an unknown type of resource')
